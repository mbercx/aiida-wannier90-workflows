...
def get_pseudo_orbitals(pseudos: ty.Mapping[str, PseudoPotentialData]) -> dict:
    ...
    Currently only support the following pseudopotentials installed by `aiida-pseudo`:
        ...
        3. PseudoDojo/0.4/LDA/SR/standard/upf
        3. PseudoDojo/0.4/LDA/SR/stringent/upf
        4. PseudoDojo/0.4/PBE/SR/standard/upf
        5. PseudoDojo/0.4/PBE/SR/stringent/upf
        6. PseudoDojo/0.5/PBE/SR/standard/upf
        7. PseudoDojo/0.5/PBE/SR/stringent/upf
    """
